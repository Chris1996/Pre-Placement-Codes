...
lhr.dun.daily.temp.mean <- VisualizeAverages( Heathrow, Dundee, c("Time", "TemperatureC"))

lhr.dun.weekly.temp.mean <- VisualizeAverages( Heathrow, Dundee, c("Time", "TemperatureC"), 
                                               TimeDif = week)

lhr.dun.monthly.temp.mean <- VisualizeAverages( Heathrow, Dundee, c("Time", "TemperatureC"), 
                                                TimeDif = month)

lhr.dun.daily.temp.median <- VisualizeAverages( Heathrow, Dundee, c("Time", "TemperatureC"), 
                                                Average = median)

lhr.dun.weekly.temp.median <- VisualizeAverages( Heathrow, Dundee, c("Time", "TemperatureC"), 
                                              TimeDif = week, Average = median)

lhr.dun.monthly.temp.median <- VisualizeAverages( Heathrow, Dundee, c("Time", "TemperatureC"), 
                                                  TimeDif = month, Average = median)

temp.correlation <- CorrelatedValues( Heathrow, Dundee, c("Time", "TemperatureC"))

pressure.correlation <- CorrelatedValues( Heathrow, Dundee, c("Time", "Sea_Level_PressurehPa"))
visual.pressure.cor <- VisualizeAverages( Heathrow, Dundee, c("Time", "Sea_Level_PressurehPa"))

humidity.correlation <- CorrelatedValues( Heathrow, Dundee, c("Time", "Humidity"))
visual.humidity.cor <- VisualizeAverages( Heathrow, Dundee, c("Time", "Humidity"))

wind.speed.correlation <- CorrelatedValues( Heathrow, Dundee, c("Time", "Wind_SpeedKm_h"))
visual.ws.cor <- VisualizeAverages( Heathrow, Dundee, c("Time", "Wind_SpeedKm_h"))

lhr.events.pressure <- VisualizeRelationshipsBoxplot( Heathrow, c("Events", "Sea_Level_PressurehPa"))
lhr.rain.pressure <- VisualizeRelationshipsBoxplot( Heathrow, c("Events", "Sea_Level_PressurehPa"), Rain = T)

dun.events.pressure <- VisualizeRelationshipsBoxplot( Dundee, c("Events", "Sea_Level_PressurehPa"))
dun.rain.pressure <- VisualizeRelationshipsBoxplot( Dundee, c("Events", "Sea_Level_PressurehPa"), Rain = T)
